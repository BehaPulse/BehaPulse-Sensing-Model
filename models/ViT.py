...
class ViT(nn.Module):
    def __init__(self, in_channels, embed_dim, num_layers, num_heads, mlp_dim, n_classes, patch_size, in_size):
        super().__init__()
        self.patch_embed = PatchEmbedding(in_channels, embed_dim, patch_size)
        self.cls_token = nn.Parameter(torch.zeros(1, 1, embed_dim))
        self.num_patches = (in_size[0] // patch_size[0]) * (in_size[1] // patch_size[1])
